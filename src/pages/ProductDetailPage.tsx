  ...
  return (
    <div id={`product-page-${product.slug}`} className="min-h-screen pt-24 pb-20 bg-[#0b0f17]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section id="product-demo" className="mb-20 p-8 sm:p-12 rounded-3xl bg-[#080d16] border border-cyan-500/40 shadow-2xl">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-slate-400 mt-1">
                Simule um disparo de transação ou interaja com o console de execução.
              </p>
            </div>
            ...
            <button
              ...
              className="px-5 py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold text-xs uppercase tracking-wider shadow-md hover:scale-105 active:scale-95 disabled:opacity-50 transition-all flex items-center gap-2 cursor-pointer shrink-0"
            >
              {isProcessingDemo ? (
                <>
                ...
                <>
                  ...
                  <span>Executar Fluxo de Teste</span>
                </>
              )}
            </button>
          </div>
          ...
          {/* SIMULATOR TERMINAL */}
          <div className="rounded-2xl bg-black border border-slate-800 p-4 sm:p-6 font-mono text-xs">
            <div className="flex items-center justify-between pb-3 mb-4 border-b border-slate-800 text-slate-500 text-[11px]">
              <div className="flex items-center gap-2">
                <span className="w-2.5 h-2.5 rounded-full bg-rose-500" />
                <span className="w-2.5 h-2.5 rounded-full bg-amber-500" />
                <span className="w-2.5 h-2.5 rounded-full bg-emerald-500" />
                <span className="ml-2 text-slate-400">terminal@antum-node-01:~</span>
              </div>
              <span className="text-cyan-400">Ambiente Seguro de Demonstração</span>
            </div>
            ...
            <div className="mt-4 pt-3 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-slate-500 text-[11px]">
              <span>Simulação conectada à engine da ANTUM</span>
              <button
                onClick={() => openMarinaModal(`Quero agendar uma demonstração completa ao vivo do produto ${product.name}.`)}
                className="text-cyan-400 hover:text-cyan-300 font-bold flex items-center gap-1 cursor-pointer"
              >
                <span>Solicitar demonstração personalizada com dados da sua empresa</span>
